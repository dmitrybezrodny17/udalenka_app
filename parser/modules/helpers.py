def get_exp(description_text):
	...
	y1 = ['1+ ', '1 y', '1 г', '1 ле', '1 р', '1+ г', '1+ л', '1+ р', '1-го го', 'не менее одного', 'не менее год', 'более одного', 'один год', '1-2', '1-3', '1 to 2', '1 to 3', '1 до 2', '1 до 3', 'half a year', 'полгода', 'півроку', '1-y']
	y2 = ['2+ ', '2 y', '2 г', '2 ле', '2 р', '2+ г', '2+ л', '2+ р', '2-х р', '2-х л', '2х л', '2х р', 'двох', 'двух', '2-3', '2-4', '2-5', '2 to 3', '2 to 4', '2 to 5', '2 до 3', '2 до 4', '2 до 5', '1.5', '1,5', 'полтора', 'півтора', '2-y']
	y3 = ['3+ ', '3 y', '3 г', '3 ле', '3 р', '3+ г', '3+ л', '3+ р', '3-х р', '3-х л', '3х л', '3х р', 'трьох', 'трёх', 'трех', '3-4', '3-5', '3-6', '3 to 4', '3 to 5', '3 to 6', '3 до 4', '3 до 5', '3 до 6', '2.5', '2,5', '3-y']
	y4 = ['4+ ', '4 y', '4 г', '4 ле', '4 р', '4+ г', '4+ л', '4+ р', '4-х р', '4-х л', '4х л', '4х р', '4-5', '4-6', '4 to 5', '4 to 6', '4 до 5', '4 до 6', '3.5', '3,5', '4-y']
	y5 = ['5+ ', '5 y', '5 г', '5 ле', '5 р', '5+ г', '5+ л', '5+ р', 'пяти', '5-y']
